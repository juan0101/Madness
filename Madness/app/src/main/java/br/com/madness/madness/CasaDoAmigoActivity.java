 ...
 * Indice da classe = 3
 */
public class CasaDoAmigoActivity extends ActionBarActivity implements OnCompletionListener
{
    ...
    public void respSim() {
        Intent tela = new Intent(this, TabuleiroActivity.class);
        startActivity(tela);    }

    public void respNao() {
        Intent telaNao = new Intent(this, PlantaDaCasaActivity.class);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.casa_do_amigo);
        lv = (ListView)findViewById(R.id.listView);
        audio = MediaPlayer.create(this, R.raw.casa_do_amigo);
        playMadness();
    }
