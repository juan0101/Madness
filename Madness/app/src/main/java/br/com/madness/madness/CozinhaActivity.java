 ...
 * Indice da classe = 8
 */
public class CozinhaActivity extends ActionBarActivity implements MediaPlayer.OnCompletionListener {
    ...
    public void respSim() {
        Intent tela = new Intent(this, RuaActivity.class);
        startActivity(tela);    }

    public void respNao() {
        Intent telaNao = new Intent(this, SalaActivity.class);
