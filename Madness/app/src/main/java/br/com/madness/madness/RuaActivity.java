 ...
 * Indice da classe = 10
 */
public class RuaActivity extends ActionBarActivity implements MediaPlayer.OnCompletionListener {
    ...
    public void onCompletion(MediaPlayer mp) {
        Intent tela = new Intent(this, WinActivity.class);
        startActivity(tela);
    }
