 ...
 * Indice da classe = 4
 */
public class PlantaDaCasaActivity extends ActionBarActivity implements OnCompletionListener {
    ...
    public void onCompletion(MediaPlayer mp) {
        Intent tela = new Intent(this, DormitorioActivity.class);
        startActivity(tela);
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.planta_da_casa);
