...
public class SalaDeEstarActivity extends ActionBarActivity implements OnCompletionListener
 {
    ...
    public void respNao() {
        Intent telaNao = new Intent(this, PoraoActivity.class);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.sala_de_estar);
        lv = (ListView)findViewById(R.id.listView);
        audio = MediaPlayer.create(this, R.raw.sala_de_estar);
        playMadness();
    }
